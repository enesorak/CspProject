...
namespace CspProject.Services.Template.Templates
{
    // Yeni ITemplate arayüzünü uygulayan sınıfımız
    public class FmeaTemplate : ITemplate
    {
        public string Name => "DFMEA Template";
        public string Description => "A standard template for Design Failure Mode and Effects Analysis.";

        // FmeaTemplateGenerator.cs dosyasındaki Apply metodu artık burada.
        // Metodu "static" olmaktan çıkarıp "public" yaptık.
         public void Apply(IWorkbook workbook)
        {
...
// (dataStyle'dan dikey ortalamayı zaten aldılar ama burada tekrar belirtmek de sorun olmaz)
        ...
        // FmeaTemplateGenerator.cs dosyasındaki CreateHeader metodu artık burada.
        // Metodu "static" olmaktan çıkarıp "private" yaptık.
        ...
        // FmeaTemplateGenerator.cs dosyasındaki GetSeverityScale metodu artık burada.
        // Metodu "static" olmaktan çıkarıp "private" yaptık.
